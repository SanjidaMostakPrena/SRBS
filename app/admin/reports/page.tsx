      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-3 sm:mb-4 md:mb-6 lg:mb-8 bg-white/30 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl p-3 sm:p-4 md:p-5 lg:p-6 shadow-xl border border-white/40">
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white p-2 sm:p-2.5 md:p-3 rounded-xl sm:rounded-2xl shadow-lg flex-shrink-0">
              <BarChart3 className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 lg:h-8 lg:w-8" />
            </div>
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm text-gray-600 hidden sm:block truncate">Sales, Collection, Due & Stock analysis</p>
            </div>
          </div>
          <button
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-3 sm:mb-4 md:mb-5 lg:mb-6">
          <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 shadow-lg border border-white/50 hover:shadow-xl transition group">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                ...
                <p className="text-base sm:text-lg md:text-2xl font-bold text-blue-700 truncate">৳{totalSales.toFixed(2)}</p>
              </div>
          ...
          <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 shadow-lg border border-white/50 hover:shadow-xl transition group">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Total Collection</p>
                <p className="text-base sm:text-lg md:text-2xl font-bold text-green-700 truncate">৳{totalCollected.toFixed(2)}</p>
              </div>
          ...
          <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 shadow-lg border border-white/50 hover:shadow-xl transition group">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                ...
                <p className="text-base sm:text-lg md:text-2xl font-bold text-amber-700 truncate">৳{totalDueAmount.toFixed(2)}</p>
              </div>
              <div className="bg-amber-100 p-2 sm:p-3 rounded-lg sm:rounded-xl group-hover:scale-110 transition flex-shrink-0">
                <CreditCard className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-amber-600" />
              </div>
            </div>
          </div>
          <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 shadow-lg border border-white/50 hover:shadow-xl transition group">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Stock Items</p>
                <p className="text-base sm:text-lg md:text-2xl font-bold text-purple-700 truncate">{totalStock}</p>
              </div>
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl p-3 sm:p-4 md:p-5 lg:p-6 shadow-2xl border border-white/50 mb-3 sm:mb-4 md:mb-5 lg:mb-6">
          <div className="flex flex-col md:flex-row md:items-center gap-3 sm:gap-4">
            <div className="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3">
              ...
              >
                <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4 inline mr-0.5 sm:mr-1" />
              ...
              >
                <Wallet className="h-3 w-3 sm:h-4 sm:w-4 inline mr-0.5 sm:mr-1" />
              ...
              >
                <CreditCard className="h-3 w-3 sm:h-4 sm:w-4 inline mr-0.5 sm:mr-1" />
              ...
              >
                <Package className="h-3 w-3 sm:h-4 sm:w-4 inline mr-0.5 sm:mr-1" />
            ...
            <div className="flex-1 flex flex-wrap gap-2 sm:gap-3 items-center">
              <div className="flex flex-wrap items-center gap-1 sm:gap-2">
                ...
                <input
                  ...
                  className="px-1.5 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm border-2 border-gray-200 rounded-lg sm:rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-400 outline-none transition-all bg-white/50 backdrop-blur-sm w-[100px] sm:w-auto"
                />
                <span className="text-gray-400 text-xs sm:text-sm hidden xs:inline">to</span>
                <input
                  type="date"
                  name="to"
                  value={dateRange.to}
              ...
              <div className="flex-1 relative min-w-[100px]">
                ...
                <input
                  ...
                  className="w-full pl-7 sm:pl-9 pr-2 sm:pr-3 py-1 sm:py-1.5 text-xs sm:text-sm border-2 border-gray-200 rounded-lg sm:rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-400 outline-none transition-all bg-white/50 backdrop-blur-sm"
                />
              </div>
            </div>
          </div>
  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6 animate-fadeIn">
      <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Total Revenue</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-blue-700 truncate">৳{totalSales.toFixed(2)}</p>
        </div>
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Total Orders</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-green-700 truncate">{totalOrders}</p>
        </div>
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Total Profit</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-amber-700 truncate">৳{totalProfit.toFixed(2)}</p>
        </div>
      </div>
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
        <div className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 border-b border-gray-200/50 bg-gradient-to-r from-blue-50 to-indigo-50">
          <h3 className="text-xs sm:text-sm font-semibold text-gray-700">Daily Sales Details</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-xs sm:text-sm">
            <thead className="bg-white/30">
              <tr>
                <th className="text-left px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Date</th>
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Orders</th>
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Revenue (৳)</th>
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600 hidden sm:table-cell">Profit (৳)</th>
              </tr>
            </thead>
            <tbody>
              {data.map((d, i) => (
                <tr key={i} className="border-b border-gray-100/60 hover:bg-white/30 transition">
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-gray-700 text-xs sm:text-sm">{new Date(d.date).toLocaleDateString()}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-medium text-gray-800 text-xs sm:text-sm">{d.orders}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-medium text-blue-700 text-xs sm:text-sm">৳{d.revenue.toFixed(2)}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-medium text-amber-700 text-xs sm:text-sm hidden sm:table-cell">৳{d.profit.toFixed(2)}</td>
                </tr>
              ))}
            </tbody>
          </table>
    ...
    <div className="space-y-3 sm:space-y-4 md:space-y-6 animate-fadeIn">
      <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          ...
          <p className="text-sm sm:text-base md:text-xl font-bold text-green-700 truncate">৳{totalCollected.toFixed(2)}</p>
        </div>
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Total Due</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-amber-700 truncate">৳{totalDue.toFixed(2)}</p>
        </div>
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Collection Rate</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-blue-700 truncate">{collectionRate.toFixed(1)}%</p>
        </div>
      </div>

      <div className="bg-white/70 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
        <div className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 border-b border-gray-200/50 bg-gradient-to-r from-green-50 to-emerald-50">
          <h3 className="text-xs sm:text-sm font-semibold text-gray-700">Daily Collection Details</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-xs sm:text-sm">
            <thead className="bg-white/30">
              <tr>
                <th className="text-left px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Date</th>
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Collected (৳)</th>
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600 hidden sm:table-cell">Due (৳)</th>
              </tr>
            </thead>
            <tbody>
              {data.map((d, i) => (
                <tr key={i} className="border-b border-gray-100/60 hover:bg-white/30 transition">
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-gray-700 text-xs sm:text-sm">{new Date(d.date).toLocaleDateString()}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-medium text-green-700 text-xs sm:text-sm">৳{d.collected.toFixed(2)}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-medium text-amber-700 text-xs sm:text-sm hidden sm:table-cell">৳{d.due.toFixed(2)}</td>
                </tr>
              ))}
            </tbody>
          </table>
...
const DueReport: React.FC<DueReportProps> = ({ data, totalDueAmount, criticalDue }) => {
  ...
  const statusIcons = {
    current: <CheckCircle className="h-2.5 w-2.5 sm:h-3 sm:w-3" />,
    overdue: <Clock className="h-2.5 w-2.5 sm:h-3 sm:w-3" />,
    critical: <AlertCircle className="h-2.5 w-2.5 sm:h-3 sm:w-3" />,
  };
  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6 animate-fadeIn">
      <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Total Due</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-amber-700 truncate">৳{totalDueAmount.toFixed(2)}</p>
        </div>
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Critical Due</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-red-700 truncate">{criticalDue}</p>
        </div>
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Overdue Customers</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-amber-700 truncate">{data.filter(d => d.status === "overdue" || d.status === "critical").length}</p>
        </div>
      </div>

      <div className="bg-white/70 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
        <div className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 border-b border-gray-200/50 bg-gradient-to-r from-amber-50 to-orange-50">
          <h3 className="text-xs sm:text-sm font-semibold text-gray-700">Outstanding Due</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-xs sm:text-sm">
            <thead className="bg-white/30">
              <tr>
                ...
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600 hidden sm:table-cell">Days Overdue</th>
                <th className="text-center px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Status</th>
              </tr>
            </thead>
            <tbody>
              {data.map((d, i) => (
                <tr key={i} className="border-b border-gray-100/60 hover:bg-white/30 transition">
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-medium text-gray-800 text-xs sm:text-sm truncate max-w-[80px] sm:max-w-none">{d.customer}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-bold text-amber-700 text-xs sm:text-sm">৳{d.amount.toFixed(2)}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right text-gray-600 text-xs sm:text-sm hidden sm:table-cell">{d.daysOverdue}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-center">
                    <span className={`text-[10px] sm:text-xs font-medium px-2 sm:px-3 py-0.5 sm:py-1 rounded-full inline-flex items-center gap-0.5 sm:gap-1 ${statusColors[d.status]}`}>
                      {statusIcons[d.status]}
                      <span className="hidden xs:inline">{statusLabels[d.status]}</span>
                      <span className="xs:hidden">{d.status === "current" ? "Cur" : d.status === "overdue" ? "Ovd" : "Crit"}</span>
                    </span>
                  </td>
                </tr>
              ))}
...
const StockReport: React.FC<StockReportProps> = ({ data, totalStock, lowStockItems }) => {
  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6 animate-fadeIn">
      <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Total Stock</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-purple-700 truncate">{totalStock}</p>
        </div>
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Low Stock Items</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-amber-700 truncate">{lowStockItems}</p>
        </div>
        <div className="bg-white/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
          <p className="text-[10px] xs:text-xs sm:text-sm text-gray-500 truncate">Out of Stock</p>
          <p className="text-sm sm:text-base md:text-xl font-bold text-red-700 truncate">{data.filter(d => d.status === "out-of-stock").length}</p>
        </div>
      </div>
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
        <div className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 border-b border-gray-200/50 bg-gradient-to-r from-purple-50 to-pink-50">
          <h3 className="text-xs sm:text-sm font-semibold text-gray-700">Product Stock Details</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-xs sm:text-sm">
            <thead className="bg-white/30">
              <tr>
                <th className="text-left px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Product</th>
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600 hidden sm:table-cell">Warehouse</th>
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600 hidden md:table-cell">Dealer</th>
                <th className="text-right px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Total</th>
                <th className="text-center px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-semibold text-gray-600">Status</th>
              </tr>
            </thead>
            <tbody>
              {data.map((d, i) => (
                <tr key={i} className="border-b border-gray-100/60 hover:bg-white/30 transition">
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 font-medium text-gray-800 text-xs sm:text-sm truncate max-w-[80px] sm:max-w-none">{d.product}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-medium text-blue-700 text-xs sm:text-sm hidden sm:table-cell">{d.warehouse}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-medium text-purple-700 text-xs sm:text-sm hidden md:table-cell">{d.dealer}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-right font-bold text-gray-800 text-xs sm:text-sm">{d.total}</td>
                  <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 text-center">
                    <span className={`text-[10px] sm:text-xs font-medium px-2 sm:px-3 py-0.5 sm:py-1 rounded-full inline-flex items-center gap-0.5 sm:gap-1 ${statusColors[d.status]}`}>
                      {d.status === "in-stock" ? <CheckCircle className="h-2.5 w-2.5 sm:h-3 sm:w-3" /> : <AlertCircle className="h-2.5 w-2.5 sm:h-3 sm:w-3" />}
                      <span className="hidden xs:inline">{statusLabels[d.status]}</span>
                      <span className="xs:hidden">{d.status === "in-stock" ? "In" : d.status === "low" ? "Low" : "Out"}</span>
                    </span>
                  </td>
                </tr>
              ))}
