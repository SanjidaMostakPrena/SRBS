        ...
        <div className="mb-3 sm:mb-4 md:mb-6 lg:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 rounded-2xl sm:rounded-3xl border border-white/40 bg-white/30 p-3 sm:p-4 md:p-5 lg:p-6 shadow-xl backdrop-blur-xl">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            <button
              ...
              className=" cursor-pointer flex items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-3 sm:px-4 md:px-5 py-1.5 sm:py-2.5 text-xs sm:text-sm md:text-base font-semibold text-white shadow-lg transition hover:shadow-xl hover:scale-105"
            >
