...
//                 Area Management
//               </h1>
//               <p className="text-gray-600">Manage sales territories and service areas</p>
//             </div>
//           </div>
//           <button
...
//                   <th className="text-left px-6 py-4 font-semibold text-gray-700">Area Name</th>
...
//                       <td className="px-6 py-4 font-medium text-gray-800">{area.name}</td>
//                       <td className="px-6 py-4 font-mono text-xs text-gray-500">{area.code}</td>
...
//                   {editingArea ? "Area updated successfully!" : "Area added successfully!"}
//                 </div>
//               )}
