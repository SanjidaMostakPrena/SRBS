...
//                 Admin Overview
//               </h1>
//               <p className="text-xs sm:text-sm text-gray-600">Your business at a glance</p>
//             </div>
//           </div>
...
//           {/* Weekly Sales Chart */}
//           <div className="bg-white/70 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-2xl border border-white/50">
//             <h3 className="text-base sm:text-lg font-bold text-gray-700 mb-3 sm:mb-4">Weekly Sales</h3>
...
//           <div className="bg-white/70 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-2xl border border-white/50">
//             <h3 className="text-base sm:text-lg font-bold text-gray-700 mb-3 sm:mb-4">Monthly Collection</h3>
//             <div className="w-full h-[200px] sm:h-[240px] md:h-[280px]">
//               <ResponsiveContainer width="100%" height="100%">
...
//           {/* Recent Orders */}
//           <div className="bg-white/70 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl border border-white/50 overflow-hidden lg:col-span-1">
//             <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200/50 bg-gradient-to-r from-blue-50 to-indigo-50 flex items-center justify-between">
...
//                 Recent Orders
//               </h3>
//               <button className="text-xs sm:text-sm text-blue-600 hover:text-blue-800 transition">View All</button>
//             </div>
//             <div className="p-3 sm:p-4 space-y-2 sm:space-y-3">
//               {RECENT_ORDERS.map((order) => (
//                 <div
//                   key={order.id}
//                   className="flex items-center justify-between p-2.5 sm:p-3 bg-white/40 backdrop-blur-sm rounded-xl border border-gray-100/60 hover:border-blue-300 transition-all hover:shadow-md"
//                 >
...
//           {/* Low Stock Alerts */}
//           <div className="bg-white/70 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl border border-white/50 overflow-hidden lg:col-span-1">
//             <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200/50 bg-gradient-to-r from-red-50 to-amber-50 flex items-center justify-between">
//               <h3 className="text-xs sm:text-sm font-semibold text-gray-700 flex items-center gap-2">
//                 <AlertCircle className="h-3 w-3 sm:h-4 sm:w-4 text-red-500" />
//                 Low Stock Alerts
//               </h3>
//               <button className="text-xs sm:text-sm text-red-600 hover:text-red-800 transition">View All</button>
//             </div>
//             <div className="p-3 sm:p-4 space-y-2 sm:space-y-3">
//               {LOW_STOCK_PRODUCTS.map((product, index) => (
//                 <div
//                   key={index}
//                   className="flex items-center justify-between p-2.5 sm:p-3 bg-white/40 backdrop-blur-sm rounded-xl border border-red-100/60 hover:border-red-300 transition-all hover:shadow-md"
//                 >
//                   <div className="flex-1 min-w-0">
...
//                     </p>
//                   </div>
//                   <span className={`text-[10px] sm:text-xs font-medium px-2 sm:px-3 py-0.5 sm:py-1 rounded-full flex-shrink-0 ${
//                     product.stock === 0
...
//           {/* Quick Actions */}
//           <div className="bg-white/70 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl border border-white/50 overflow-hidden lg:col-span-1">
//             <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200/50 bg-gradient-to-r from-purple-50 to-pink-50">
//               <h3 className="text-xs sm:text-sm font-semibold text-gray-700 flex items-center gap-2">
...
//         <div className="mt-4 sm:mt-6 bg-white/60 backdrop-blur-md rounded-2xl p-3 sm:p-4 shadow-lg border border-white/50">
...
//               </span>
//             </div>
//             <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-gray-500 text-[10px] sm:text-xs">
...
//           <p className="text-[10px] sm:text-sm text-gray-500 truncate">{title}</p>
...
//               )}
//               <span className={`text-[8px] sm:text-xs font-medium ${trend === "up" ? "text-green-600" : "text-red-600"}`}>
//                 {trendValue}
//               </span>
//               <span className="text-[8px] sm:text-xs text-gray-400 hidden xs:inline">vs last month</span>
//             </div>
//           )}
//         </div>
//         <div className={`p-2 sm:p-3 rounded-xl ${colorMap[color]} group-hover:scale-110 transition flex-shrink-0`}>
//           {icon}
//         </div>
//       </div>
//     </div>
...
//   const statusMap = {
//     pending: { label: "Pending", icon: <Clock className="h-2 w-2 sm:h-3 sm:w-3" />, className: "bg-amber-100 text-amber-700" },
//     approved: { label: "Approved", icon: <CheckCircle className="h-2 w-2 sm:h-3 sm:w-3" />, className: "bg-blue-100 text-blue-700" },
//     completed: { label: "Completed", icon: <CheckCircle className="h-2 w-2 sm:h-3 sm:w-3" />, className: "bg-green-100 text-green-700" },
//     rejected: { label: "Rejected", icon: <AlertCircle className="h-2 w-2 sm:h-3 sm:w-3" />, className: "bg-red-100 text-red-700" },
//   };
//   const { label, icon, className } = statusMap[status];
//   return (
//     <span className={`text-[8px] sm:text-xs font-medium px-1.5 sm:px-3 py-0.5 sm:py-1 rounded-full inline-flex items-center gap-0.5 sm:gap-1 ${className} flex-shrink-0`}>
//       {icon}
...
//     <a
//       href={href}
//       className={`flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 bg-white/40 backdrop-blur-sm rounded-xl border ${colorMap[color]} hover:border-${color}-400 transition-all hover:shadow-md group`}
//     >
//       <div className={`p-1.5 sm:p-2 rounded-xl bg-${color}-100 text-${color}-600 group-hover:scale-110 transition flex-shrink-0`}>
//         {icon}
//       </div>
//       <div className="min-w-0 flex-1">
//         <p className="font-medium text-gray-800 text-xs sm:text-sm truncate">{label}</p>
//         <p className="text-[8px] sm:text-xs text-gray-500 truncate">{description}</p>
//       </div>
//       <ArrowUpRight className="h-3 w-3 sm:h-4 sm:w-4 text-gray-400 ml-auto group-hover:text-gray-600 group-hover:translate-x-0.5 transition flex-shrink-0" />
//     </a>
//   );
// };
"use client";
