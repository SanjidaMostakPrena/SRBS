...
function AdminLoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 🔥 কোনো নির্দিষ্ট credentials চেক করা হচ্ছে না – যেকোনো বৈধ ইনপুট গ্রহণ
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    } rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 sm:text-sm`}
                ...
                {!emailError && email.trim().length > 0 && (
                  <p className="mt-1.5 text-sm text-gray-500">Enter a valid email address</p>
                )}
              </div>
