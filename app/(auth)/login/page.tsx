          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 lg:space-y-6">
            <div className="space-y-3 sm:space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-8 sm:pl-9 md:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 bg-gray-50 border ${
                      phoneError ? 'border-red-500' : 'border-gray-200'
                    } rounded-xl text-gray-900 text-sm sm:text-base placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200`}
                    placeholder="Enter numeric phone number"
                    value={phone}
                    onChange={handlePhoneChange}
                    disabled={loading}
                ...
                {phoneError && (
                  <p className="mt-1 sm:mt-1.5 text-xs sm:text-sm text-red-600">{phoneError}</p>
                )}
                {!phoneError && phone.length > 0 && (
            ...
            {/* General error (fallback) */}
            {phoneError === 'An error occurred. Please try again.' && (
              <div className="flex items-center gap-2 text-red-600 text-xs sm:text-sm bg-red-50 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-red-100">
                <svg
