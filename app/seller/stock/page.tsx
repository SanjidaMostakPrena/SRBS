  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-2 sm:p-3 md:p-4 lg:p-6 xl:p-8">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-3 sm:mb-4 md:mb-5 lg:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/40 bg-white/30 p-3 sm:p-4 md:p-5 lg:p-6 shadow-xl backdrop-blur-xl">
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm text-gray-600 truncate">Warehouse & Dealer inventory</p>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            <div className="flex items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-xl border border-white/50 bg-white/40 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 text-[10px] sm:text-xs md:text-sm text-gray-700 shadow-sm backdrop-blur-sm">
              <Package className="h-3 w-3 sm:h-3.5 sm:w-3.5 md:h-4 md:w-4" />
              <span className="hidden xs:inline">{totalProducts} products</span>
              <span className="xs:hidden">{totalProducts}</span>
            </div>
          </div>
        </div>

        {/* Summary Cards */}
        <div className="mb-3 sm:mb-4 md:mb-5 grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
          <div className="group rounded-xl sm:rounded-2xl border border-white/50 bg-white/60 p-3 sm:p-4 md:p-5 shadow-lg backdrop-blur-md transition hover:shadow-xl">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-lg sm:rounded-xl bg-blue-100 p-1.5 sm:p-2 md:p-3 transition group-hover:scale-110 flex-shrink-0">
          ...
          <div className="group rounded-xl sm:rounded-2xl border border-white/50 bg-white/60 p-3 sm:p-4 md:p-5 shadow-lg backdrop-blur-md transition hover:shadow-xl">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-lg sm:rounded-xl bg-green-100 p-1.5 sm:p-2 md:p-3 transition group-hover:scale-110 flex-shrink-0">
          ...
          <div className="group rounded-xl sm:rounded-2xl border border-white/50 bg-white/60 p-3 sm:p-4 md:p-5 shadow-lg backdrop-blur-md transition hover:shadow-xl">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-lg sm:rounded-xl bg-purple-100 p-1.5 sm:p-2 md:p-3 transition group-hover:scale-110 flex-shrink-0">
          ...
          <div className="group rounded-xl sm:rounded-2xl border border-white/50 bg-white/60 p-3 sm:p-4 md:p-5 shadow-lg backdrop-blur-md transition hover:shadow-xl">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-lg sm:rounded-xl bg-red-100 p-1.5 sm:p-2 md:p-3 transition group-hover:scale-110 flex-shrink-0">
        ...
        {/* Filters */}
        <div className="mb-3 sm:mb-4 md:mb-5 rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/50 bg-white/60 p-3 sm:p-4 md:p-5 shadow-lg backdrop-blur-md">
        ...
        {/* Main Stock Table */}
        <div className="mb-4 sm:mb-6 md:mb-8 overflow-hidden rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/50 bg-white/70 shadow-2xl backdrop-blur-xl">
