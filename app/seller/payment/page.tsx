...
//       return (
//         <div className="absolute left-0 right-0 top-full mt-1 bg-white/80 backdrop-blur-md border border-gray-200 rounded-xl shadow-xl z-20 p-4 text-center text-gray-500">
...
//           <button
//             key={customer.id}
//             className="w-full text-left px-4 py-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-colors flex items-center justify-between border-b border-gray-100 last:border-0"
...
//             </div>
//             <div className="text-sm font-semibold text-gray-700 bg-white/50 px-3 py-1 rounded-full">
...
//               <span className="font-bold text-blue-700">৳{totalCollected.toFixed(2)}</span>
//             </div>
//           </div>
//         </div>
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <p className="text-sm text-gray-500">Total Pending Due</p>
//                 <p className="text-2xl font-bold text-amber-600">৳{totalPendingDue.toFixed(2)}</p>
//               </div>
...
//                 <p className="text-2xl font-bold text-purple-700">{customersWithDue}</p>
//               </div>
...
//             <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-2xl border border-white/50 hover:shadow-3xl transition">
...
//                     <div className="flex items-center border-2 border-gray-200 rounded-2xl bg-white/50 backdrop-blur-sm focus-within:ring-4 focus-within:ring-blue-200 focus-within:border-blue-400 transition-all">
//                       <Search className="h-5 w-5 text-gray-400 ml-4" />
//                       <input
//                         type="text"
//                         placeholder="Search customer by name, phone or email..."
//                         className="w-full px-4 py-3 outline-none bg-transparent text-gray-700 rounded-2xl"
...
//                   </div>
//                   {selectedCustomer && (
//                     <div className="mt-3 flex flex-wrap items-center gap-3 text-sm bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-2xl border border-blue-100/60">
...
//                       <span className="text-gray-500">|</span>
//                       <span className="font-semibold text-amber-600 bg-amber-100 px-3 py-1 rounded-full">
...
//                       className={`w-full pl-10 pr-4 py-3 border-2 rounded-2xl focus:ring-4 focus:ring-blue-200 focus:border-blue-400 outline-none transition-all bg-white/50 backdrop-blur-sm ${
...
//                     className="w-full px-4 py-3 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-200 focus:border-blue-400 outline-none transition-all bg-white/50 backdrop-blur-sm"
//                   />
//                 </div>

//                 {/* Feedback */}
//                 {submitError && (
//                   <div className="bg-red-50/80 backdrop-blur-sm text-red-700 p-4 rounded-2xl text-sm flex items-start gap-2 border border-red-200">
//                     <AlertCircle className="h-5 w-5 mt-0.5 flex-shrink-0" />
//                     <span>{submitError}</span>
//                   </div>
//                 )}
//                 {submitSuccess && (
//                   <div className="bg-green-50/80 backdrop-blur-sm text-green-700 p-4 rounded-2xl text-sm flex items-center gap-2 border border-green-200">
...
//                   className={`w-full py-4 rounded-2xl font-bold text-white text-lg transition-all flex items-center justify-center gap-2 shadow-lg ${
...
//             <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-white/50 sticky top-6">
...
//                     <div
//                       key={payment.id}
//                       className="group p-4 bg-white/40 backdrop-blur-sm rounded-2xl border border-gray-100/60 hover:border-blue-300 transition-all hover:shadow-md"
//                     >
//                       <div className="flex items-center justify-between">
//                         <div>
...
//                             <span className="truncate max-w-[100px]">{payment.remarks}</span>
//                           </div>
//                         </div>
