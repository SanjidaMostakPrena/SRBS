...
export default function DealersPage() {
  ...
  // ============================================================
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-2 sm:p-3 md:p-4 lg:p-6 xl:p-8">
      {/* Background decorations */}
      <div className="pointer-events-none absolute top-0 right-0 h-32 w-32 sm:h-48 sm:w-48 md:h-64 md:w-64 lg:h-80 lg:w-96 translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-bl from-blue-200/20 to-indigo-200/20 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        {/* Header */}
        <div className="mb-3 sm:mb-4 md:mb-5 lg:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/40 bg-white/30 p-3 sm:p-4 md:p-5 lg:p-6 shadow-xl backdrop-blur-xl">
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            <div className="rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 p-2 sm:p-2.5 md:p-3 text-white shadow-lg flex-shrink-0">
              <Store className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 lg:h-8 lg:w-8" />
            </div>
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm text-gray-600 truncate">Manage all dealers and distributors</p>
            </div>
          </div>
        </div>
        ...
        {/* Filters */}
        <div className="mb-3 sm:mb-4 md:mb-5 rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/50 bg-white/70 p-3 sm:p-4 md:p-5 lg:p-6 shadow-2xl backdrop-blur-xl">
          <div className="flex flex-col md:flex-row md:items-center gap-3 sm:gap-4">
            <div className="flex-1 relative min-w-0">
              ...
              <input
                type="text"
                placeholder="Search by name, contact, phone, code or area..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
        ...
        {/* Dealers Table */}
        <div className="overflow-hidden rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/50 bg-white/70 shadow-2xl backdrop-blur-xl">
          {/* Desktop Table View */}
            ...
            <table className="w-full text-xs sm:text-sm">
              <thead className="border-b border-gray-200/50 bg-gradient-to-r from-blue-50 to-indigo-50">
                <tr>
                  ...
                  <th className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 text-left font-semibold text-gray-700">Code</th>
                  <th className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 text-left font-semibold text-gray-700">Dealer Info</th>
              ...
              <tbody>
                {filteredDealers.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="py-6 sm:py-10 text-center text-gray-400">
                  ...
                  filteredDealers.map((dealer, index) => (
                    ...
                    >
                      ...
                      <td className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4">
                        <div>
                          <p className="font-medium text-gray-800 text-xs sm:text-sm truncate max-w-[120px] sm:max-w-[200px]">{dealer.name}</p>
                          <p className="text-[10px] sm:text-xs text-gray-500 truncate max-w-[120px] sm:max-w-[200px]">{dealer.address}</p>
                        </div>
                      </td>
                      <td className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4">
                        <div>
                          <p className="text-xs sm:text-sm text-gray-700 truncate max-w-[100px]">{dealer.contactPerson}</p>
                          <p className="flex items-center gap-0.5 sm:gap-1 text-[10px] sm:text-xs text-gray-500">
                            <Phone className="h-2.5 w-2.5 sm:h-3 sm:w-3" />
                            <span className="truncate max-w-[80px]">{dealer.phone}</span>
                          </p>
                        </div>
                      </td>
                    </tr>
          ...
          <div className="md:hidden divide-y divide-gray-100/60">
            {filteredDealers.length === 0 ? (
              ...
              filteredDealers.map((dealer, index) => (
                <div key={dealer.id} className="p-3 sm:p-4 hover:bg-white/30 transition">
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-[10px] sm:text-xs text-gray-400">#{index + 1}</span>
                        <span className="font-mono text-xs sm:text-sm font-medium text-gray-700">{dealer.dealerCode}</span>
                      </div>
                      <h3 className="text-sm sm:text-base font-semibold text-gray-800 truncate">{dealer.name}</h3>
                      <p className="text-xs sm:text-sm text-gray-500 truncate">{dealer.address}</p>
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 mt-0.5">Contact: {dealer.contactPerson}</p>
                      {dealer.gstNumber && (
                        <p className="text-[10px] sm:text-xs text-gray-400 mt-0.5">GST: {dealer.gstNumber}</p>
                      )}
                    </div>
                  </div>
                </div>
